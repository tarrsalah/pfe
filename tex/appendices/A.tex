...
Les propriétés sont de ressources qui décrivent les relations entres
des autres resources, par exemple \emph{``écrit par''} et \emph{``est
  de type de''}. Commes toutes les resources, les propriétés sont
identifiées par des \acrshort{uri}, une propriété peut être aussi
déréférencée pour trouver une description textuelle de cette
propriété.
