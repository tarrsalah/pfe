...
% make a short summary of what rdfs is.

% * what is rdfs and why we need it (what rdfs add to rdf)?

% * rdfs as primitive ontologies definition language and its
% primitives

% * rdfs vs rdf layers

% * why rdfs is built upon rdf?

% * some examples of rdfs inferance rules
