...
\begin{enumerate}
\item Rendre les données structurées et semi-structurées disponibles
  dans formats normalisés et standardisés sur le Web;\medskip
...
% respect the AAA slogan!!!

\begin{enumerate}
\item Use labeled graph as the data mode; for objects and their
  relastions;\medskip

\item Use \acrshort{uri} to identify the individual data-items and
  their relastions that appear in the datasets;\medskip

\item Use ontologies as the data-model to fotmally represent the
