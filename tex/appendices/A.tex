...
composantes principales sont introduites en
section~\ref{sec:semantic-web-rdf-rdf}.\medskip

\subsection{RDF~: Le modèle de données}
\label{sec:semantic-web-rdf-rdf}

Les concepts fondamentals de \acrshort{rdf} sont les ressources, les
