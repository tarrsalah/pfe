...
\ref{sec:semantic-web-owl2-syntax-semantics} et
\ref{sec:semantic-web-owl2-tools} respectivement, nous abordons le
language \acrshort{owl}\footnote{Dans sa deuxième version
  \cite{w3c2009owl}} suivi par un exposé d'un ensemble d'outils
utilisés pour la manipulation les documents \acrshort{owl}.
...
\subsection{ OWL2 tools}
\label{sec:semantic-web-owl2-tools}
