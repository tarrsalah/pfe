...
données qui nous permet de publier, exploiter et réutiliser de données
fortement connectées (\emph{``Smart
...
% Importantly, this graph can be created in a distributed fashion by
% multiple different participants just by using the same URLs. This
% allows us to create a Web of Data allowing for knowledge to be
% reused.\medskip
