...
% TODO: relational vs graph database
  ...
  stockage en termes des nœuds et des arcs directement.
    ...
    % These graph databases will have their own file systems to store
    % the data instead of relying on other storage techniques. As the
    % name implies, these databases are always optimized to store and
    % manage graph-like relation- ship data. At the same time, they may
    % share some features to fulfill the requirements as high
