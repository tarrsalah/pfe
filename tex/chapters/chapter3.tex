...
\newpage
  ...
  tels que Google Amazon, Facebook et eBay. En bref, les bases de
  données \textsc{NoSQL} peuvent être catégorisées selon leur modèle
  ...
  \subsection{Langages d'interrogation des bases de données graphe
}
