...
% Ses notations sont utilisées par Freddy Lécué dans ses travaux
% \cite{lecue2006formal, lecue2008composition} sur la composition de
% services Web sémantiques.

Le reste de cette section est consacré à décrir et définir
formellement ces trois fonctions de \emph{Matching} ({\large
