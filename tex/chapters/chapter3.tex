...
atomique, et que chaque paramètre est annoté à un concept dans
...
réaliser un \textit{Matching} horizontal
\ref{sec:ch3/semantic-matching} (la figure \ref{fig:ch4/gd}) entre les
...
\begin{mydef}[\textbf{Problème de composition}]
  ...
  composite $\mathpzc{S_Q}$ satisfaisant la requête $\mathpzc{Q}$.
\end{mydef}
