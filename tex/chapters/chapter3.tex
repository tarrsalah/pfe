...
\label{sec:ch3/architecture-goals}

\subsection{Analyse des exigences}
\label{sec:ch3/architecture-requirements}

\newpage
\subsection{Architecture du système}
\label{sec:ch3/architecture-system}

L'architecture proposée pour la conception et la mise en œuvre du
notre système est illustrée dans la figure~\ref{fig:ch3/architecture}.
