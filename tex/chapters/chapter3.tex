...
Dans notre approche proposée, nous nous intéressons seulement à
l'aspcet fonctionnel de services Web publiés où les descriptions
sémantiques de paramètres d'\emph{entrée/sortie} sont exploitées pour
...
pour le reste du chapitre {\large $\mathpzc{Sim_C}$, $\mathpzc{Sim_S}$
  et $\mathpzc{Sim_L}$}. ses notations sont utilisées par Freddy Lécué
dans ses travaux \cite{lecue2006formal, lecue2008composition,
  lecue2009optimizing} sur la composition de services Web sémantiques.
