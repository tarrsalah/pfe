...
% des services) ou pendant le traitement de la requête de composition
  ...
  \begin{text}
    ...
    dépendances entres les entrés/sorties des services disponibles
    dans un graphe dont les sommets représentent les paramètres
    \textit{(entrées/sorties)} et les arcs représentent les
