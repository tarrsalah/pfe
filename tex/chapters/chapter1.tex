...
définir le concept \textit{``Service oriented computing''}
(\acrshort{soc}) comme une solution émergente de développement rapide
des applications distribuées dans les environnements hétérogènes. Nous
présentons ensuite l'architecture orientée services pour réaliser le
...
la littérature.
  ...
  Afin de mettre en œuvre une \acrshort{soa}, il est essentiel d'avoir
