...
\subsection{Services Web}
  ...
  le cas poue les scripts \acrshort{cgi} ou les applications CORBA par
  exemple.
  ...
  Cette définition surligne les caractéristiques suivantes de services
  ...
  \emph{découvertes}, \emph{invoquées} et \emph{composées} à travers
  le Web grâce à l'utilisation de l'Internet (avec \acrshort{http})
  comme infrastructure de communication ainsi que de formats de
  données standardisés comme \acrshort{xml}.
...
illustre les ralations sous-jacentes entres ces spécifications et la
...
spécifications, leurs origines, structures et fonctionalités de base.
  ...
  distribués. \acrshort{soap} est basé sur \textsc{XML} pour mettre en
