...
rencontrées dans la littérature.
  ...
  % L'origine de cette approche est issue du domaine de recherche
  % d'information, les modèles mathématiques du calcule de similarité
  % syntaxique sont présentées brièvement dans l'annexe
  % \ref{sec:syntactic-sim}.
