...
\label{sec:ws-localisation}
  ...
  les paramètres descriptives \textit{fonctionnels} et \textit{non
    fonctionnels} du service requis et ceux des services
  offrets.\medskip
  ...
  est effectué. Le calcul de similarité peut être basé sur des données
  syntaxiques ou sémantiques plus expressives \cite{elie2010}.
