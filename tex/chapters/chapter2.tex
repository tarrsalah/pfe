...
\newpage
  ...
  littérature.
    ...
    %% d'une composition de services Web.
    ...
    % composition statique de services web est considérée rigide et
    ...
    % \cite{driss2011approche}
      ...
      \item[Composition statique] :est appelé aussi composition
        ...
        % clients. La composition de services web prend place durant la
        ...
        % mettre en place de services composites qui implémente des
      ...
      \item[Composition dynamique]: appelée aussi composition
        ...
        % disponibilité de services Web, ...etc. La composition
        ...
        % dans lequel de services apparaissent et disparaissent
        % rapidement. La composition de services web implique : - La
        % découverte des « bons » services à composer selon les besoins
        % et la disponibilité de services.  - La dynamicité et la
  ...
  % % TODO change the font of commands in BPEL et al....
    ...
    % tout comme les autres standards de services Web. WS-BPEL permet
  ...
  \subsection{La composition  basée sur les workflows}
    ...
    % ``le workflow est le procédé par lequel les tâches individuelles
    % sont assemblées pour compléter une transaction – un procédé métier
    % clairement définis – à l'intérieur d'une entrepris.''
