...
\newpage
  ...
  littérature.
   ...
   % TODO: vertical vs horiontal composition
    ...
    % When composing Web Services, two different execution models are
    % usually applied: Orchestration and Choreogra- phy. There is not a
    % common sense regarding these two definitions,
    ...
    % \cite{driss2011approche}
      ...
      modèles d'exécution appliqués dans le contexte d'une composition.    
      \SpecialItem
  ...
  %   % elie2010
    ...
    Le standard \textsc{WMSF} est centré autour de deux principes
    complémentaire:
    ...
    % We compare the composition standards described above according to
