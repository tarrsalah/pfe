...
\item[Invoquer (bind)]: Finalement, le service doit être invoqué. Dans
  cette opération, le client invoque ou initie une interaction avec le
  service utilisant les détails de liaison dans la description du
  service pour le localiser, contacter et l'appeler.
\end{description}
