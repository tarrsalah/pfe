...
découverte.
  ...
  % Beaucoup d‘efforts ont été proposés pour décrire les capacités d‘un
  % service web, nous distinguons les descriptions syntaxiques et les
  % descriptions sémantiques, chacune d‘elles offre des facettes
  % décrivant soit la structure et/ou le comportement du composant.
