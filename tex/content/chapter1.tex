...
\newpage
  ...
  web, ensuite nous introduisons l'architecture étendus.
    ...
    \item[L'annuaire] Un registre de service est une façon dont les
      ...
      % A service registry is a way in which Web services
    ...
    \item[Le client] Un client de services est le consommateur d'un
      ...
      % A service requester is the consumer of a Web service
    ...
    \newpage
      ...
      \input{figs/soap_all.tex} %% La structure d’un message SOAP
      Ce protocole \textsc{SOAP} est basé sur \textsc{XML} pour mettre
      en place un mécanisme valable d'échange des données indépendant
      du modèle de programmation de l'application et du système
      d’exploitation.
